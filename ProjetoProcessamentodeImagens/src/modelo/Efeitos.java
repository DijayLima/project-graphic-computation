...
public class Efeitos extends PanelDaImagem {
	...
	/**
	 * Aplica o efeito negativo básico em matrizImagem, através da função S = 255 - nivelDeCinzaPixel
	 */
	 ...
	 * 
	 * @param c = 1
	 * @param r = valor do pixel (nível de cinza)
	 * @param 0 <= gamma <= 1
	 * 
	 */
	...
	/**
	 * Aplica a transformação Logaritmo em r_matrizImagem através da fórmula: S = alog(r+1).
	 * 
	...
	/**
	 * Aplica a transferência de intensidade geral (ITF sigmoide) em r_matrizImagem através da função:
	 ...
	 * @param fmin = pixel de menor valor
	 * @param fmax = pixel de maior valor
	...
	/**
	 * Aplica a transferência linear em r_matrizImagem.
	 * 
	...
	/**
	 * Encontra o pixel de maior valor de matrizImagem
	 * 
	 */
	...
	/**
	 * Encontra o pixel de menor valor de matrizImagem
	 * 
	 */
